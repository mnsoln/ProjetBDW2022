...
if(file_exists('../private-config-bd.php'))  // fichier de configuration "privé" (enseignants)
	...
	define('UTILISATRICE', 'p2209453'); // votre login, par exemple p1234567
	define('MOTDEPASSE', 'Cradle96Barrel'); // votre mot de passe, par exemple Abcd12Efgh
	define('BDD', 'p2209453'); // votre BD, par exemple p1234567	
}
?>
