...
function getConnexionBD() {
	$connexion = mysqli_connect('univ-lyon1.fr', 'p2209453', 'Cradle96Barrel','p2209453');
...
// retourne les infos sur la critique
function getCritique($connexion, $nomSerie) {
	$nomSerie = mysqli_real_escape_string($connexion, $nomSerie); // sécurisation de $nomSerie
	$requete = "SELECT * FROM Critiques WHERE nomSerie = '". $nomSerie . "'" ;
	$res = mysqli_query($connexion, $requete);
	$series = mysqli_fetch_all($res, MYSQLI_ASSOC);
}
